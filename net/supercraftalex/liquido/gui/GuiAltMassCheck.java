...
public class GuiAltMassCheck extends GuiScreen {

	private GuiScreen parent;
	private String status;
	private GuiTextField loginField;
	
	public GuiAltMassCheck(GuiScreen guiMainMenu) {
		parent = guiMainMenu;
	}
	...
	public void initGui() {
		...
		buttonList.add(new GuiButton(5, this.width/2-width/2, this.height-(height+offset)*3, width, height, "MassChecker"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, "Information: TheAltening alts please paste and add :0 behind the alt", this.width / 2, 30, Color.WHITE.getRGB());
					...
					try {
						...
						if(args[0].contains("@")) {
							...
							if(args[0].contains("supercraftalex") || args[0].contains("sca")) {
							    ...
							    if (loginField.getText().contains("@alt.com")) {
