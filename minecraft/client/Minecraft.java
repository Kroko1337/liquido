...
import net.supercraftalex.liquido.events.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        new Liquido().onReady();
        Display.setTitle(Liquido.NAME + " " + Liquido.VERSION);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Liquido.NAME+" "+Liquido.VERSION + "...");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	for(Module m : Liquido.getInstance().moduleManager.getModules()) {
                    		if(k == m.getKeyBind()) {
                    			m.toggle();
                    		}
                    	}
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Liquido.getInstance().getDiscordRP().update("Playing Singleplayer", "Local");
    }
